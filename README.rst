...
----------
This is a fork from Martijn Braam's code at https://github.com/MartijnBraam/gpsd-py3. Hopefully Martijn will incorporate these changes to his code.

- Added support to pull time information (UTC)
- Able to pull time with Timezone Offset (Local Time)
